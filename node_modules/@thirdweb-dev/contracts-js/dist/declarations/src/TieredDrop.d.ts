...
export interface TieredDropInterface extends utils.Interface {
    functions: {
        ...
        "getMetadataInTier(string)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "approve" | "balanceOf" | "burn" | "claimWithSignature" | "contractType" | "contractURI" | "contractVersion" | "encryptDecrypt" | "encryptedData" | "getApproved" | "getBaseURICount" | "getBatchIdAtIndex" | "getDefaultRoyaltyInfo" | "getMetadataInTier" | "getRevealURI" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "getRoyaltyInfoForToken" | "getTokensInTier" | "getTokensInTierLen" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "initialize" | "isApprovedForAll" | "isEncryptedBatch" | "isTrustedForwarder" | "lazyMint" | "multicall" | "name" | "nextTokenIdToMint" | "owner" | "ownerOf" | "primarySaleRecipient" | "renounceRole" | "reveal" | "revokeRole" | "royaltyInfo" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setContractURI" | "setDefaultRoyaltyInfo" | "setOwner" | "setPrimarySaleRecipient" | "setRoyaltyInfoForToken" | "supportsInterface" | "symbol" | "tokenURI" | "totalMinted" | "totalMintedInTier" | "totalSupply" | "transferFrom" | "verify"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "getMetadataInTier", values: [string]): string;
    ...
    decodeFunctionResult(functionFragment: "getMetadataInTier", data: BytesLike): Result;
...
export declare type RequestExecutedEvent = TypedEvent<[
    string,
    string,
    ISignatureAction.GenericRequestStructOutput
], RequestExecutedEventObject>;
export declare type RequestExecutedEventFilter = TypedEventFilter<RequestExecutedEvent>;
...
export interface TieredDrop extends BaseContract {
    ...
    functions: {
        ...
        getMetadataInTier(_tier: string, overrides?: CallOverrides): Promise<[
            LazyMintWithTier.TokenRangeStructOutput[],
            string[]
        ] & {
            tokens: LazyMintWithTier.TokenRangeStructOutput[];
            baseURIs: string[];
        }>;
    ...
    estimateGas: {
        ...
        getMetadataInTier(_tier: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getMetadataInTier(_tier: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
