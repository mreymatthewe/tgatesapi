...
var zod = require('zod');
var QueryParams = require('./QueryParams-86dd442c.cjs.prod.js');
...
const ClaimConditionInputSchema = zod.z.object({
  ...
  metadata: zod.z.union([zod.z.string(), zod.z.object({})]).optional()
});
/**
 * @internal
 */
...
async function prepareClaim(quantity, activeClaimCondition, merkleMetadataFetcher, tokenDecimals, contractWrapper, storage, checkERC20Allowance, snapshotFormatVersion) {
  ...
  const pricePerToken = priceInProof.toString() !== ethers.ethers.constants.MaxUint256.toString() ? priceInProof : activeClaimCondition.price; // same for currency address
...
async function getClaimerProofs(addressToClaim, merkleRoot, tokenDecimals, merkleMetadata, storage, provider, snapshotFormatVersion) {
  ...
  const price = claim.price === "unlimited" || claim.price === undefined ? ethers.ethers.constants.MaxUint256 : await normalizePriceValue(provider, claim.price, claim.currencyAddress || ethers.ethers.constants.AddressZero);
  const maxClaimable = claim.maxClaimable === "unlimited" ? ethers.ethers.constants.MaxUint256 : ethers.ethers.utils.parseUnits(claim.maxClaimable, tokenDecimals);
  return {
    proof: claim.proof,
    maxClaimable,
    price,
    currencyAddress: claim.currencyAddress || ethers.ethers.constants.AddressZero
  };
}
/**
 * @internal
...
async function fetchTokenMetadata(tokenId, tokenUri, storage) {
  ...
  return QueryParams.CommonNFTOutput.parse({ ...jsonMetadata,
      ...
      if (allowListEntry) {
        try {
          ...
          if (this.isLegacyMultiPhaseDrop(this.contractWrapper)) {
            ...
            if (convertQuantityToBigNumber(claimCondition.maxClaimablePerWallet, decimals).eq(0) && allowListEntry.maxClaimable === ethers.ethers.constants.MaxUint256 || allowListEntry.maxClaimable === ethers.BigNumber.from(0)) {
              reasons.push(exports.ClaimEligibility.AddressNotAllowed);
              return reasons;
            }
          } else if (this.isNewMultiphaseDrop(this.contractWrapper)) {
      ...
      if (allowListEntry) {
        try {
          ...
          if (this.isLegacyMultiPhaseDrop(this.contractWrapper)) {
            ...
            if (claimCondition.maxClaimablePerWallet === "0" && allowListEntry.maxClaimable === ethers.ethers.constants.MaxUint256 || allowListEntry.maxClaimable === ethers.BigNumber.from(0)) {
              reasons.push(exports.ClaimEligibility.AddressNotAllowed);
              return reasons;
            }
          } else if (this.isNewMultiphaseDrop(this.contractWrapper)) {
...
class Erc20ClaimableWithConditions {
  ...
  constructor(erc20, contractWrapper, storage) {
    QueryParams._defineProperty(this, "featureName", FEATURE_TOKEN_CLAIMABLE_WITH_CONDITIONS.name);
...
class Erc721Claimable {
  constructor(erc721, contractWrapper) {
    QueryParams._defineProperty(this, "featureName", FEATURE_NFT_CLAIMABLE.name);
...
class Erc721ClaimableWithConditions {
  ...
  constructor(erc721, contractWrapper, storage) {
    QueryParams._defineProperty(this, "featureName", FEATURE_NFT_CLAIMABLE_WITH_CONDITIONS_V2.name);
...
class Erc721TieredDrop {
  ...
  async reveal(batchId, password) {
    ...
    const chainId = await this.contractWrapper.getChainID();
    const key = ethers.ethers.utils.solidityKeccak256(["string", "uint256", "uint256", "address"], [password, chainId, batchId, this.contractWrapper.readContract.address]); // performing the reveal locally to make sure it'd succeed before sending the transaction
...
class Erc721WithQuantitySignatureMintable {
  constructor(contractWrapper, storage) {
    QueryParams._defineProperty(this, "featureName", FEATURE_NFT_SIGNATURE_MINTABLE.name);
...
class ERC1155Claimable {
  constructor(contractWrapper) {
    QueryParams._defineProperty(this, "featureName", FEATURE_EDITION_CLAIMABLE.name);
...
class Erc1155ClaimableWithConditions {
  constructor(contractWrapper, storage) {
    QueryParams._defineProperty(this, "featureName", FEATURE_EDITION_CLAIMABLE_WITH_CONDITIONS.name);
...
class Erc1155LazyMintable {
  ...
  constructor(erc1155, contractWrapper, storage) {
    QueryParams._defineProperty(this, "featureName", FEATURE_EDITION_LAZY_MINTABLE.name);
...
const EditionDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([await EditionDropInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./edition-drop-2d84d078.cjs.prod.js'); }), provider.getNetwork()]);
  ...
  getAbi: async (address, provider) => {
    ...
    return contractInfo.version > 2 ? (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/contracts-js/dist/abis/DropERC1155.json')); })).default : (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/contracts-js/dist/abis/DropERC1155_V2.json')); })).default;
  }
};
const EditionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./edition-4385b118.cjs.prod.js'); }), provider.getNetwork()]);
...
const MarketplaceInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./marketplace-c4ecbcea.cjs.prod.js'); }), provider.getNetwork()]);
...
const MultiwrapInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./multiwrap-7d9565dd.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTCollectionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./nft-collection-650d53bf.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./nft-drop-f9b9d57e.cjs.prod.js'); }), provider.getNetwork()]);
  ...
  getAbi: async (address, provider) => {
    ...
    return contractInfo.version > 3 ? (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/contracts-js/dist/abis/DropERC721.json')); })).default : (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/contracts-js/dist/abis/DropERC721_V3.json')); })).default;
  }
};
const PackInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./pack-edd08dd3.cjs.prod.js'); }), provider.getNetwork()]);
...
const SignatureDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./signature-drop-381b3804.cjs.prod.js'); }), provider.getNetwork()]);
  ...
  getAbi: async (address, provider) => {
    ...
    return contractInfo.version > 4 ? (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/contracts-js/dist/abis/SignatureDrop.json')); })).default : (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/contracts-js/dist/abis/SignatureDrop_V4.json')); })).default;
  }
};
const SplitInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./split-472a4b22.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./token-drop-68fa2d73.cjs.prod.js'); }), provider.getNetwork()]);
  ...
  getAbi: async (address, provider) => {
    ...
    return contractInfo.version > 2 ? (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/contracts-js/dist/abis/DropERC20.json')); })).default : (await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('@thirdweb-dev/contracts-js/dist/abis/DropERC20_V2.json')); })).default;
  }
};
const TokenInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./token-9a867bb7.cjs.prod.js'); }), provider.getNetwork()]);
...
const VoteInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider), Promise.resolve().then(function () { return require('./vote-fe589888.cjs.prod.js'); }), provider.getNetwork()]);
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  constructor(network) {
    ...
    QueryParams._defineProperty(this, "auth", void 0);
