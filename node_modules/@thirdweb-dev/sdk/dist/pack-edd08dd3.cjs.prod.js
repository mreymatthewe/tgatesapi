...
var thirdwebCheckout = require('./thirdweb-checkout-61c25441.cjs.prod.js');
var zod = require('zod');
...
class Pack extends thirdwebCheckout.StandardErc1155 {
  ...
  constructor(network, address, storage) {
    ...
    let contractWrapper = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : new thirdwebCheckout.ContractWrapper(network, address, abi, options.gasless && "openzeppelin" in options.gasless ? { ...options,
      gasless: {
  ...
  async toPackContentArgs(metadataWithRewards) {
    ...
    for (const erc20 of erc20Rewards) {
      const normalizedQuantity = await thirdwebCheckout.normalizePriceValue(provider, erc20.quantityPerReward, erc20.contractAddress); // Multiply the quantity of one reward by the number of rewards
