 ...
 */
export declare function prepareClaim(quantity: BigNumberish, activeClaimCondition: ClaimCondition, merkleMetadataFetcher: () => Promise<Record<string, string>>, tokenDecimals: number, contractWrapper: ContractWrapper<any>, storage: ThirdwebStorage, checkERC20Allowance: boolean, snapshotFormatVersion: SnapshotFormatVersion): Promise<ClaimVerification>;
/**
 * @internal
 * @param merkleRoot
 ...
 */
export declare function getClaimerProofs(addressToClaim: string, merkleRoot: string, tokenDecimals: number, merkleMetadata: Record<string, string>, storage: ThirdwebStorage, provider: ethers.providers.Provider, snapshotFormatVersion: SnapshotFormatVersion): Promise<{
    proof: string[];
